...
import edu.umich.med.michr.track.service.impl.TrackingRequestServiceImpl;
...
class TrackingRequestServiceImplTest {
  ...
  class ValidationExceptionTests {
    ...
    void shouldThrowExceptionWhenPageUrlIsMissing() {
      ...
      assertEquals("Missing required parameters: site-id or page-url", exception.getMessage());
